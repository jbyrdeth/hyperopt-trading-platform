#!/usr/bin/env python3
"""
Test Validation Script - Inside src directory

Test the backtesting engine fix with proper imports.
"""
...
def test_strategies():
    """Test a few strategies to verify the fix works."""
...
if __name__ == "__main__":
    ...
    if success:
        print(f"\n🚀 Quick test passed! Backtesting engine fix confirmed.")
    else:
